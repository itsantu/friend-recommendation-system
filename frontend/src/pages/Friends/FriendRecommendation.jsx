...
const FriendRecommendation = () => {
  const friendRecommendation = useSelector(state => state.friendRecommendation.friendRecommendation)
  return (
    <div className="max-w-lg mt-5 mx-auto bg-white shadow-md rounded-lg overflow-hidden">
      <h2 className="text-2xl font-bold bg-gray-200 p-4">Recommendation</h2>
